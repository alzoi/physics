...
Если к элементу Si добавить примесь As, то получим молекулу со свободным одним электноном (этот электрон не участвует в ковалентной связи Si и As), который легко может срываться с внешней оболочки.  
Пока к полупроводнику не подведён ток, то свободные электроны хаотично перемещаются между атомами. После подсоединения полупроводника к источнику энергии, свободные электноны срываются с внешней орбитали и устремляются к плюсу источника энергии.  
