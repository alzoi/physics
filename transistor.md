...
Если к элементу Si добавить примесь As (легировать мышьяком), то получим молекулу со свободным одним электроном (этот электрон не участвует в ковалентной связи Si и As), который легко может срываться с внешней оболочки.
